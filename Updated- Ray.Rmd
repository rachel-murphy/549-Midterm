...
```{r}
ggplot(phd1, aes(age, thalach))+ geom_point(aes(color = pres, shape = exang)) + theme_classic()
```
...
clusplot(distmatrix, k$cluster, color=TRUE, shade=TRUE, 
    labels=2, lines=0, main = "Two Groupings of Kmeans")
```
